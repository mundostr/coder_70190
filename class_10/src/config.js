 ...
 */
// Verificamos el valor de la opción mode de línea de comandos, para decidir cargar
// un paquete de variables de entorno u otro
// dotenv.config({ path: '.env_devel' });
dotenv.config({ path: clOptions.mode === 'devel' ? '.env_devel' : '.env_prod' });
